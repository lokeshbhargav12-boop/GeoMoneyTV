...
const ABOUT_LINKS = [
  {
    ...
    description: 'Our terms of service, liability limitations, and usage guidelines.',
    color: 'text-geo-gold',
    bg: 'bg-geo-gold/10',
  ...
  },
  {
    ...
    description: 'Our research methodology, AI transparency, and how we use AI in our analysis.',
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-16">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            About <span className="bg-gradient-to-r from-geo-gold to-yellow-600 bg-clip-text text-transparent">GeoMoney</span>
          </h1>
          <div className="space-y-4">
            <p className="text-lg text-gray-300 leading-relaxed">
              GeoMoney is a geopolitical analysis and market intelligence platform focused on the intersection of energy systems, resources, and global power.
            </p>
            <p className="text-base text-gray-400 leading-relaxed">
              We analyze how shifts in energy flows, commodity supply chains, financial systems, and policy decisions shape markets, economies, and geopolitical outcomes. Our work focuses on structured analysis across complex global dynamics.
            </p>
            <p className="text-base text-gray-400 leading-relaxed">
        ...
        <div className="mt-16 border-t border-white/10 pt-8">
          <p className="text-gray-500 text-sm leading-relaxed max-w-3xl">
            ...
            taken based on this information are solely at your own risk. Some content may incorporate 
            AI-assisted analysis as part of the research process.
          </p>
        </div>
      </div>
    </main>
