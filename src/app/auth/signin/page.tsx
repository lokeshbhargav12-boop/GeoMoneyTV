    ...
    <div className="flex min-h-screen items-center justify-center bg-geo-dark px-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          {logoUrl ? (
            <img src={logoUrl} alt="GeoMoney TV" className="mx-auto h-20 w-auto object-contain" />
          ) : (
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center text-sm text-gray-400">
            ...
            <a href="/auth/register" className="font-medium text-geo-gold hover:text-yellow-500">
              Register here
            </a>
          </div>
        </form>
