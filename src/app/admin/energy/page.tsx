    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-gray-400">
          Configure energy section content and data sources
        </p>
      </div>
      ...
      <div className="rounded-lg border border-white/10 bg-white/5 p-12 text-center">
        ...
        <p className="text-gray-400 max-w-md mx-auto">
          Energy section management will allow you to configure energy data
          sources, calculator parameters, and geopolitics analyzer settings.
        </p>
        <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
          {[
            { label: "Energy Hub", status: "Active" },
            { label: "Coal", status: "Active" },
            ...
            >
              ...
              <p
                className={`text-xs mt-1 ${item.status === "Active" ? "text-green-400" : "text-gray-500"}`}
              >
                {item.status}
              </p>
            </div>
