...
import { Menu, X, LogOut, LayoutDashboard, FileText, Video, Gem, Mail, Home, Zap, Users, Settings } from 'lucide-react'
...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-geo-dark text-white flex">
      ...
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-black/90 border-r border-white/10 flex flex-col transform transition-transform duration-200 lg:translate-x-0 lg:static lg:z-auto ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        {/* Logo */}
