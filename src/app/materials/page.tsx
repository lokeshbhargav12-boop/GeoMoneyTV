                ...
                {loading ? (
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {Array.from({ length: 6 }).map((_, i) => (
                            <div key={i} className="rounded-xl border border-white/10 bg-white/5 p-6 animate-pulse h-48" />
                        ))}
                    </div>
                ) : materials.length > 0 ? (
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="rounded-xl border border-white/10 bg-white/5 p-16 text-center">
                        ...
                        <p className="text-gray-400 text-lg">No rare earth materials found.</p>
                        <p className="text-gray-500 text-sm mt-2">Add materials from the admin panel.</p>
                    </div>
                )}
            </div>
        </div>
