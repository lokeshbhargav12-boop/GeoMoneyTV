...
export default function AnalyticsDashboardPage() {
  ...
  const selected =
    INSTRUMENTS.find((i) => i.id === selectedId) ?? INSTRUMENTS[0];
  ...
  const fetchSentiment = useCallback(
    async (symbol: string, forceRefresh = false) => {
      ...
      try {
        ...
        setSentimentError(
          "Unable to load market intelligence. Please try again.",
        );
      } finally {
    ...
    <main className="min-h-screen bg-geo-dark text-white pt-32">
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 hidden sm:block">
                Live Global Macro Intelligence
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-gray-600 hidden md:block">
              GeoMoney Intelligence Platform · AI Powered
            </span>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 mt-1">
          <div
            className="flex overflow-x-auto gap-0 pb-0"
      ...
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 pt-6 pb-16 space-y-10">
        ...
        <section>
          <div className="flex items-center justify-between mb-5">
            ...
            >
              <RefreshCw
                className={`w-3 h-3 ${sentimentLoading ? "animate-spin" : ""}`}
              />
              Refresh
            </button>
          </div>
          ...
          {sentiment && !sentimentLoading && (
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div
                  className={`relative rounded-xl border ${trendBorder} ${trendBg} p-5 overflow-hidden`}
                >
                  {/* Accent bar at top */}
                  <div
        ...
        <section>
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-xs text-gray-500">
              Track economic indicators across 50+ markets
            </span>
          </div>
        ...
        <div className="border-t border-white/10 pt-6 text-center">
          <p className="text-xs text-gray-600 leading-relaxed">
            GeoMoney Intelligence Platform · AI market analysis powered by
            GeoMoney AI Engine · For informational purposes only. Not financial
            advice.
          </p>
        </div>
      </div>
