...
const BRIEF_FEATURES = [
  {
    ...
    description: "Key market movements distilled into actionable bullet points",
  },
  {
    icon: Shield,
    title: "Risk Assessment",
    description: "Weekly geopolitical and market risk analysis",
  },
  {
    icon: TrendingUp,
    title: "Sector Spotlight",
    description: "Deep dive into a different commodity sector each week",
  },
  {
    icon: Crown,
    title: "Expert Commentary",
    description: "Insights from industry veterans and fund managers",
  },
];
...
const TESTIMONIALS = [
  {
    name: "Senior Analyst",
    role: "Portfolio Manager, Global Fund",
    quote: "Essential reading for anyone in commodities.",
  },
  {
    name: "Industry Executive",
    role: "CEO, Mining Corp",
    quote: "The only brief I read before my Monday meetings.",
  },
  {
    name: "Chief Economist",
    role: "Leading Investment Bank",
    quote: "Concise, actionable, and always ahead of the curve.",
  },
];
    ...
    <main className="min-h-screen bg-gradient-to-br from-geo-dark via-black to-geo-dark text-white">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-24">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-gray-400 hover:text-geo-gold transition-colors mb-12"
          >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-geo-gold/20 rounded-full border border-geo-gold/30 mb-6">
                ...
                <span className="text-geo-gold text-sm font-medium">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                The definitive intelligence report trusted by decision makers at
                the world's leading investment firms, mining companies, and
              ...
              {message && (
                <div
                  className={`text-sm mb-4 ${status === "success" ? "text-green-400" : "text-red-400"}`}
                >
                  {message}
                </div>
              )}
            ...
            >
              ...
              <div className="bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 border border-white/10 shadow-2xl">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-bold text-lg">
                        The GeoMoney Intelligence Report
                      </div>
                      <div className="text-sm text-gray-400">
                        Issue #247 • Week of Jan 27, 2026
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div>
                    <div className="text-geo-gold font-semibold text-sm mb-2">
                      EXECUTIVE SUMMARY
                    </div>
                    <div className="space-y-2">
                      <div className="flex items-start gap-2">
                        ...
                        <span className="text-sm text-gray-300">
                          Gold breaks $2,800 resistance amid Fed pivot
                          speculation
                        </span>
                      </div>
                      <div className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-geo-gold mt-2" />
                        <span className="text-sm text-gray-300">
                          Copper inventories hit 5-year lows; supply crunch
                          imminent
                        </span>
                      </div>
                      <div className="flex items-start gap-2">
