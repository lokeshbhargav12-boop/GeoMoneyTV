...
try {
  ...
  // Also remove old risk functions
  ...
  // 4. Add Aperture Map toggle replacing Open intel drawer
  code = code.replace(
  ...
  // 6. Close the outer layout wrapper and inject DASHBOARD GRID LAYER
  ...
  console.log("Refactor master successful!");
} catch (e) {
  console.error(e);
}
